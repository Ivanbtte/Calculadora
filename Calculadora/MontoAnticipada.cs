...
{
    public partial class MontoAnticipada : Form
    {
        double interes;
        double monto;
        string tInteres;

        public MontoAnticipada()
        {
            InitializeComponent();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            monto = Convert.ToDouble(txtAnualidad.Text) * ((Math.Pow((1 + interes), Convert.ToDouble(txtTiempo.Text)) - 1) / interes)*(1+interes);
