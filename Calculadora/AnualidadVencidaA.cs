...
{
    public partial class AnualidadVencidaA : Form
    {
        double interes;
        double anualidad;
        string tInteres;

        public AnualidadVencidaA()
        {
            InitializeComponent();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            anualidad = Convert.ToDouble(txtMonto.Text) / ((Math.Pow((1 + interes), Convert.ToDouble(txtTiempo.Text)) - 1) / interes);
