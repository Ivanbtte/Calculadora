...
{
    public partial class VP_Anualidades_Vencidas : Form
    {
        double interes;
        ...
        public VP_Anualidades_Vencidas()
        {
            InitializeComponent();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            ValorPresente = Convert.ToDouble(txtAnualidad.Text) * ((1-(Math.Pow((1 + interes), -Convert.ToDouble(txtTiempo.Text)))) / interes);
