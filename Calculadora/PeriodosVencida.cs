...
{
    public partial class PeriodosVencida : Form
    {

        double periodo;
        double interes;

        public PeriodosVencida()
        {
            InitializeComponent();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            periodo =  Math.Log(((Convert.ToDouble(txtMonto.Text)* interes)/ Convert.ToDouble(txtAnualidad.Text))+1)/Math.Log(1+ interes);
