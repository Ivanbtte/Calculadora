...
{
    public partial class AnualidadAnticipadaA : Form
    {
        ...
        private bool ValidarCampos()
        {
            ...
            {
                if (control is TextBox && control != txtAnualidad)
                {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            anualidad = Convert.ToDouble(txtMonto.Text) / (((Math.Pow((1 + interes), Convert.ToDouble(txtTiempo.Text)) - 1) / interes)*(1+interes));
            txtAnualidad.Text = anualidad.ToString("F2");
            limpiar();
        }
